  ...
  return new Vuex.Store({
    ...
    actions: {
      ...
      addPost(vuexContext, post) {
        ...
        return this.$axios.$post('https://nuxt-blog-puthi.firebaseio.com/posts.json?auth=' + vuexContext.state.token, createPost)
        .then(data => {
      ...
      editPost(vuexContext, editedPost) {
        return this.$axios.$put('https://nuxt-blog-puthi.firebaseio.com/posts/' + editedPost.id + '.json?auth=' + vuexContext.state.token, editedPost)
        .then(res => {
